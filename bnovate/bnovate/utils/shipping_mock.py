...
def get_mock_tracking(awb_numbers):
    data = json.loads(mock_full)

    shipment = data['shipments'][0]
    data['shipments'] = []
    for awb_number in awb_numbers:
        this_shipment = copy.deepcopy(shipment)
        this_shipment['shipmentTrackingNumber'] = awb_number
        data['shipments'].append(this_shipment)
